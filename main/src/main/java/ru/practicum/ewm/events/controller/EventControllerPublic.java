...
import ru.practicum.ewm.events.dto.EventRequestDto;
...
public class EventControllerPublic {
    ...
    @GetMapping
    public List<EventShortDtoWithViews> getEvents(@ModelAttribute EventRequestDto requestDto, HttpServletRequest request) {
        return eventService.getEvents(requestDto, request);
    }
